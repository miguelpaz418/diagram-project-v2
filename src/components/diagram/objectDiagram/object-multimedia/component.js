...
const Name = style.span`
  ...
  font-size: .8rem;
  font-weight: bold;
  transform: rotate(-45deg) translateY(3em) translateX(3.5em);
  overflow: hidden;
`;
    ...
    return (
      <>
        <div onDoubleClick={this.handleOpen}>
          <ObjectMultimedia {...this.props} name={this.state.name} />
        </div>
...
export default withStyles(styles)(ObjectMultimediaComponent);
